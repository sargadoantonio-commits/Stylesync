      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final referenceCode = booking['referenceCode'] ?? 'SS-XXXXX';
            final serviceId = booking['serviceId'] ?? 'Unknown Service';
            final barberId = booking['barberId'] ?? 'Unknown Barber';
            final bookedDate = booking['bookedDate'] ?? 'Unknown Date';
            final bookedTime = booking['bookedTime'] ?? 'Unknown Time';
            final totalCost = booking['totalCost'] ?? 0;
